    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('academic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.AcademicCenter')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('academic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.AcademicCenter')),
                ('appoved_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invigilator_approved_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appoved_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='organiser_approved_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='organiser', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('assigned_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='permission_assigned_by', to=settings.AUTH_USER_MODEL)),
                ('district', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='permission_district', to='events.District', null=True)),
                ('institute', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='permission_district', to='events.AcademicCenter', null=True)),
                ('institute_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='permission_institution_type', to='events.InstituteType', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='PermissionType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.AcademicCenter')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.CourseMap')),
                ('language', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='creation.Language')),
                ('organiser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.Organiser')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField()),
                ('updated', models.DateTimeField()),
                ('training', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.SingleTraining')),
            ],
        ),
        migrations.CreateModel(
            name='State',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('academic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.AcademicCenter')),
                ('appoved_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='test_approved_by', to=settings.AUTH_USER_MODEL, null=True)),
                ('department', models.ManyToManyField(to='events.Department')),
                ('foss', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='creation.FossCategory')),
                ('invigilator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='test_invigilator', to='events.Invigilator', null=True)),
                ('organiser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='test_organiser', to='events.Organiser')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('test', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.Test')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated', models.DateTimeField(auto_now=True, null=True)),
                ('approved_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='testimonial_approved_by', to=settings.AUTH_USER_MODEL, null=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='testimonial_created_by', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='TestLog',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('academic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.AcademicCenter')),
                ('appoved_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='training_approved_by', to=settings.AUTH_USER_MODEL, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('language', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, default=None, to='creation.Language')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.Student')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('training', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.Training')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('language_prefered', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='creation.Language', null=True)),
                ('training', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.Training')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('batch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.StudentBatch', null=True)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.CourseMap')),
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.Department')),
                ('training_planner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.TrainingPlanner')),
            ],
        ),
        migrations.CreateModel(
            name='University',
        ...
        migrations.AddField(
            model_name='training',
            name='extra_fields',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, null=True, to='events.TrainingExtraFields'),
        ),
        migrations.AddField(
            model_name='training',
            name='foss',
        ...
        migrations.AddField(
            model_name='training',
            name='organiser',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.Organiser'),
        ),
        migrations.AddField(
            model_name='test',
            name='test_category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='test_category', to='events.TestCategory'),
        ),
        migrations.AddField(
            model_name='test',
            name='training',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.Training', null=True),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='permissiontype',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.PermissionType'),
        ),
        migrations.AddField(
            model_name='permission',
            name='state',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='permission_state', to='events.State'),
        ),
        migrations.AddField(
            model_name='permission',
            name='university',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='permission_iniversity', to='events.University', null=True),
        ),
        migrations.AddField(
            model_name='permission',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='permission_user', to=settings.AUTH_USER_MODEL),
        ),
        ...
        migrations.AddField(
            ...
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, blank=True, to='events.LabCourse', null=True),
        ),
        migrations.AddField(
            model_name='coursemap',
            name='foss',
        ...
        migrations.AddField(
            model_name='academiccenter',
            name='district',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.District'),
        ),
        migrations.AddField(
            model_name='academiccenter',
            name='institute_category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.InstituteCategory'),
        ),
        migrations.AddField(
            model_name='academiccenter',
            name='institution_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.InstituteType'),
        ),
        migrations.AddField(
            model_name='academiccenter',
            name='location',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='events.Location', null=True),
        ),
        migrations.AddField(
            model_name='academiccenter',
            name='state',
