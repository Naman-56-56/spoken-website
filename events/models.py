...
class FeedbackOpinion(models.Model):
  ...
  OPINION_MAX_LENGTH = max(len(x[0]) for x in OPINION)
  spfriendly = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  diff_watch_practice = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  satisfied_with_learning_experience = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  confident = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  side_by_side_hold_intrest = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  ws_not_useful = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  can_learn_other = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  wantto_conduct_incollege = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  esy_to_conduct_own = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  ask_student_to_use =  models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  possible_to_use_therotical = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  not_self_explanatory = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  logical_sequence = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  examples_help = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  other_language = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  instructions_easy_to_follow = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  language_complicated = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  acquired_knowledge =  models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  suff_instruction_by_prof = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  suff_instruction_by_staff = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  method_easy = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  desired_objective = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  recommend = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  like_to_part = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  learn_other_side_by_side = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  referred_forums = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  referred_forums_after = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  asked_ques_forums = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  not_answer_doubts = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  forum_helpful = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  doubts_solved_fast = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  need_not_post = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  faster_on_forums = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  not_have_to_wait = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  not_like_method_forums = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  helpful_pre_ans_ques = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  not_like_reveal_identity = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  forum_motivated = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)
  per_asked_ques_before_tuts = models.CharField(max_length = OPINION_MAX_LENGTH, choices = OPINION)

class FeedbackRate(models.Model):
  RATE_SPOKEN_CHOICES = (
    ('','-----'), ('Excellent', 'Excellent'), ('Good', 'Good'), ('Fair', 'Fair'), ('Bad', 'Bad'), ('Extremelybad', 'Extremely bad')
  )
  RATE_SPOKEN_CHOICES_LENGTH = max(len(x[0]) for x in RATE_SPOKEN_CHOICES)
  ws_quality = models.CharField(max_length = 50, choices = RATE_SPOKEN_CHOICES)
  relevance = models.CharField(max_length = 50, choices = RATE_SPOKEN_CHOICES)
  guidelines = models.CharField(max_length = 50, choices = RATE_SPOKEN_CHOICES)
  overall_video_quality = models.CharField(max_length = 50, choices = RATE_SPOKEN_CHOICES)
...
class FeedbackFeelings(models.Model):
  FEELINGS =(
    ('','-----'),('Notconfidentatall', 'Not confident at all'), ('Unconfident', 'Unconfident'), ('Neitherconfidentnorunconfident', 'Neither confident nor unconfident'), ('Confident', 'Confident'),
    ('Absolutelyconfident', 'Absolutely confident'),('NotApplicable', 'Not Applicable'))
  FEELINGS_MAX_LENGTH = max(len(x[0]) for x in FEELINGS)
...
class WorkshopFeedbackPost(models.Model):
  YES_NO_CHOICES =(
    ('','-----'), ('Yes', 'Yes'), ('No', 'No'),
  )
  YES_NO_CHOICES_LENGTH = max(len(x[0]) for x in YES_NO_CHOICES)
  GENDER_CHOICES =(
    ('', '-----'), ('Male', 'Male'), ('Female', 'Female'),
  )
  FEES =(
  ...
  install_own = models.CharField(max_length = YES_NO_CHOICES_LENGTH, choices = YES_NO_CHOICES)
  explain = models.TextField()
  used_sw_before = models.CharField(max_length = YES_NO_CHOICES_LENGTH, choices = YES_NO_CHOICES)
  sim_framework_before = models.CharField(max_length = YES_NO_CHOICES_LENGTH, choices = YES_NO_CHOICES)
  total_tutorials1 = models.CharField(max_length = 20)
  purpose_of_attending = models.CharField(max_length = 300)
  like_to_create_st = models.CharField(max_length = YES_NO_CHOICES_LENGTH, choices = YES_NO_CHOICES)
  ...
  opinion = models.ForeignKey(FeedbackOpinion, on_delete=models.CASCADE, null=True, blank=True)
  rate = models.ForeignKey(FeedbackRate, on_delete=models.CASCADE, null=True, blank=True)
  feelings = models.ForeignKey(FeedbackFeelings, on_delete=models.CASCADE, null=True, blank=True)
