...
class UsersRoles(models.Model):
    uid = models.ForeignKey(Users, db_column='uid', on_delete=models.DO_NOTHING)
    rid = models.ForeignKey(Role, db_column='rid', on_delete=models.DO_NOTHING)
...
class TutorialCommonContents(models.Model):
    id = models.IntegerField(primary_key=True)
    tutorial_detail = models.ForeignKey(TutorialDetails, on_delete=models.DO_NOTHING)
    tutorial_slide = models.TextField()
    tutorial_slide_uid = models.ForeignKey(Users, related_name='slides', db_column='tutorial_slide_uid', on_delete=models.DO_NOTHING)
    tutorial_slide_status = models.IntegerField()
    tutorial_code = models.TextField()
    tutorial_code_uid = models.ForeignKey(Users, related_name='codes', db_column='tutorial_code_uid', on_delete=models.DO_NOTHING)
    tutorial_code_status = models.IntegerField()
    tutorial_assignment = models.TextField()
    tutorial_assignment_uid = models.ForeignKey(Users, related_name='assignments', db_column='tutorial_assignment_uid', on_delete=models.DO_NOTHING)
    ...
    tutorial_prerequisit_uid = models.ForeignKey(
        Users, related_name='prerequisite', db_column='tutorial_prerequisit_uid', on_delete=models.DO_NOTHING)
    tutorial_prerequisit_status = models.IntegerField()
    tutorial_keywords = models.TextField()
    tutorial_keywords_uid = models.ForeignKey(Users, related_name='keywords', db_column='tutorial_keywords_uid', on_delete=models.DO_NOTHING)
...
class TutorialResources(models.Model):
    ...
    tutorial_content = models.ForeignKey(TutorialCommonContents, on_delete=models.DO_NOTHING)
    tutorial_outline = models.TextField()
    tutorial_outline_uid = models.ForeignKey(Users, related_name='outlines', db_column='tutorial_outline_uid', on_delete=models.DO_NOTHING)
    tutorial_outline_status = models.IntegerField()
    tutorial_script = models.TextField()
    tutorial_script_uid = models.ForeignKey(Users, related_name='scripts', db_column='tutorial_script_uid', on_delete=models.DO_NOTHING)
    tutorial_script_status = models.IntegerField()
    tutorial_script_timed = models.TextField()
    tutorial_video = models.TextField()
    tutorial_video_uid = models.ForeignKey(Users, related_name='videos', db_column='tutorial_video_uid', on_delete=models.DO_NOTHING)
...
class TutorialDomainReviewerRoles(models.Model):
    id = models.IntegerField(primary_key=True)
    uid = models.ForeignKey(Users, db_column='uid', on_delete=models.DO_NOTHING)
    language = models.ForeignKey(TutorialLanguages, on_delete=models.DO_NOTHING)
...
class TutorialUpdateLog(models.Model):
    id = models.IntegerField(primary_key=True)
    tutorial_resources = models.ForeignKey(TutorialResources, on_delete=models.DO_NOTHING)
...
class CTutorialMissingComponent(models.Model):
    id = models.IntegerField(primary_key=True)
    uid = models.ForeignKey(Users, db_column='uid', on_delete=models.DO_NOTHING)
    trid = models.ForeignKey(TutorialResources, db_column='trid', on_delete=models.DO_NOTHING)
...
class TutorialPublicReviewVideo(models.Model):
    id = models.IntegerField(primary_key=True)
    tutorial_public_review = models.ForeignKey(TutorialPublicReview, on_delete=models.DO_NOTHING)
...
class VideoComments(models.Model):
    id = models.IntegerField(primary_key=True)
    tutorial_resource = models.ForeignKey(TutorialResources, on_delete=models.DO_NOTHING)
    uid = models.ForeignKey(Users, db_column='uid', on_delete=models.DO_NOTHING)
